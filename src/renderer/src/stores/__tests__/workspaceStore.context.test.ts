 ...
 *
 * Tests for getContextForNode — the BFS traversal that injects
 * context from connected nodes into AI conversations.
 *
...
import type { ArtifactNodeData, ConversationNodeData, EdgeData, NoteNodeData } from '@shared/types'
...
describe('getContextForNode (BFS context injection)', () => {
  ...
  describe('depth traversal', () => {
    it('should traverse depth-2 (note → project → conversation)', () => {
      ...
      const project = createProjectNode([], {
        id: 'proj-1',
        data: { title: 'Middle Project', description: 'Project desc' } as Partial<
          import('@shared/types').ProjectNodeData
        >,
      })
      const conv = createConversationNode([], { id: 'conv-1' })
    ...
    it('should respect depth limit', () => {
      ...
      const project = createProjectNode([], {
        id: 'proj-1',
        data: { title: 'Middle', description: 'Middle desc' } as Partial<
          import('@shared/types').ProjectNodeData
        >,
      })
      const conv = createConversationNode([], { id: 'conv-1' })
