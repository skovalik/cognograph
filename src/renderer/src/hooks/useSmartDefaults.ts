  ...
  project: [
    {
      id: 'add-task',
      label: '+ Add task',
      prompt: 'Add a new task to this project:',
      mode: 'generate',
    },
    {
      id: 'add-note',
      label: '+ Add note',
      prompt: 'Add a context note to this project:',
      mode: 'generate',
    },
    {
      id: 'reorganize',
      label: 'Reorganize',
      prompt: 'Reorganize children by priority',
      mode: 'organize',
    },
    {
      id: 'summarize',
      label: 'Summarize',
      prompt: 'Create a summary of this project',
      mode: 'fix',
    },
  ],
  conversation: [
    ...
    },
    {
      id: 'extract-tasks',
      label: 'Extract tasks',
      prompt: 'Extract action items as tasks',
      mode: 'generate',
    },
    {
      id: 'branch',
      label: 'Branch',
      prompt: 'Create a branch conversation to explore:',
      mode: 'generate',
    },
  ],
  note: [
    ...
    },
    {
      id: 'summarize',
      label: 'Summarize',
      prompt: 'Create a shorter summary of this note',
      mode: 'fix',
    },
    {
      id: 'extract',
      label: 'Extract tasks',
      prompt: 'Extract any tasks from this note',
      mode: 'generate',
    },
    {
      id: 'connect',
      label: 'Find related',
      prompt: 'Find related nodes to connect to',
      mode: 'organize',
    },
  ],
  task: [
    ...
    },
    {
      id: 'add-context',
      label: '+ Context',
      prompt: 'Add context notes for this task',
      mode: 'generate',
    },
    {
      id: 'estimate',
      label: 'Estimate',
      prompt: 'Add effort/time estimate to this task',
      mode: 'fix',
    },
    {
      id: 'dependencies',
      label: 'Dependencies',
      prompt: 'Identify dependencies for this task',
      mode: 'organize',
    },
  ],
  artifact: [
    { id: 'explain', label: 'Explain', prompt: 'Explain what this artifact does', mode: 'fix' },
    {
      id: 'improve',
      label: 'Improve',
      prompt: 'Suggest improvements for this artifact',
      mode: 'refactor',
    },
    {
      id: 'document',
      label: 'Document',
      prompt: 'Generate documentation for this artifact',
      mode: 'generate',
    },
    {
      id: 'connect',
      label: 'Connect',
      prompt: 'Find conversations that could use this artifact',
      mode: 'organize',
    },
  ],
  workspace: [
    {
      id: 'overview',
      label: 'Overview',
      prompt: 'Create an overview of this workspace',
      mode: 'fix',
    },
    {
      id: 'organize',
      label: 'Organize',
      prompt: 'Organize nodes within this workspace',
      mode: 'organize',
    },
    {
      id: 'add-conversation',
      label: '+ Chat',
      prompt: 'Add a new conversation to this workspace',
      mode: 'generate',
    },
  ],
  text: [
    { id: 'expand', label: 'Expand', prompt: 'Expand this text with more detail', mode: 'fix' },
    {
      id: 'convert',
      label: 'To Note',
      prompt: 'Convert this text to a note node',
      mode: 'refactor',
    },
    {
      id: 'connect',
      label: 'Connect',
      prompt: 'Connect this text to related nodes',
      mode: 'organize',
    },
  ],
  action: [
    { id: 'configure', label: 'Configure', prompt: 'Configure this action node', mode: 'fix' },
    {
      id: 'test',
      label: 'Test',
      prompt: 'Create a test workflow for this action',
      mode: 'generate',
    },
  ],
}
...
const EMPTY_CANVAS_ACTIONS: QuickAction[] = [
  {
    ...
    prompt: 'Create a new project for',
    mode: 'generate',
  },
  {
    id: 'add-conversation',
    label: 'Add conversation',
    prompt: 'Add a new AI conversation about',
    mode: 'generate',
  },
  {
    id: 'import-ideas',
    label: 'Import ideas',
    prompt: 'Create notes for these ideas:',
    mode: 'generate',
  },
]
...
const MULTI_SAME_TYPE_ACTIONS: QuickAction[] = [
  { id: 'organize', label: 'Organize', prompt: 'Organize these nodes', mode: 'organize' },
  {
    id: 'summarize',
    label: 'Summarize all',
    prompt: 'Create a summary of all selected nodes',
    mode: 'fix',
  },
  {
    id: 'connect',
    label: 'Find connections',
    prompt: 'Find and create connections between these nodes',
    mode: 'organize',
  },
]
...
const MULTI_MIXED_ACTIONS: QuickAction[] = [
  { id: 'group', label: 'Group', prompt: 'Group these into a new project', mode: 'generate' },
  {
    id: 'connect',
    label: 'Connect',
    prompt: 'Connect these nodes where relevant',
    mode: 'organize',
  },
