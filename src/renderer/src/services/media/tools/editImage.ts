...
export const editImageTool: MediaToolDefinition = {
  name: 'edit_image',
  description:
    'Edit an existing image using AI. Supports inpainting (edit specific regions), outpainting (extend canvas), remove background, and upscale. Reference an artifact node containing the source image.',
  input_schema: {
    type: 'object',
    properties: {
      image_node_id: {
