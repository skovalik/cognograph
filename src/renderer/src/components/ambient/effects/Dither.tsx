...
void main() {
  ...
  col = mix(baseColor, col, effectOpacity);
...
interface WaveUniforms {
  ...
  effectOpacity: THREE.Uniform<number>;
...
function DitheredWaves({
  ...
  const waveUniformsRef = useRef<WaveUniforms>({
    ...
    baseColor: new THREE.Uniform(isDark ? new THREE.Color(0, 0, 0) : new THREE.Color(1, 1, 1)),
    effectOpacity: new THREE.Uniform(effectOpacity),
  ...
  // Track mouse at window level — the ambient layer has pointer-events:none
  // so R3F's onPointerMove never fires. Use a window listener instead.
  useEffect(() => {
