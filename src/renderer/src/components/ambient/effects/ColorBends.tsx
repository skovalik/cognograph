...
void main() {
  ...
  q += toward * uMouseInfluence * 0.2;
    ...
    if (uIsDark == 0) {
      float brightest = max(col.r, max(col.g, col.b));
      col = clamp(col + vec3(1.0 - brightest), 0.0, 1.0);
      a = 1.0;
    }
...
export default function ColorBends({
  ...
  return <div ref={containerRef} className={`w-full h-full relative overflow-hidden ${className}`} style={{ ...style, opacity }} />;
}
