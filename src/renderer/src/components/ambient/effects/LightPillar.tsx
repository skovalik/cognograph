...
const LightPillar: React.FC<LightPillarProps> = ({
  ...
  const effectiveBlendMode = isDark ? mixBlendMode : 'normal';

  return (
    <div ref={containerRef} className={`w-full h-full absolute top-0 left-0 ${className}`} style={{ mixBlendMode: effectiveBlendMode }} />
  );
};
