...
import { DEFAULT_GLASS_SETTINGS, DEFAULT_AMBIENT_EFFECT, PRESET_ACCENT_PALETTES, type ThemeMode, type GlassStyle, type EdgeStyle, type AccentTheme } from '@shared/types'
...
export const ThemeMenu = memo<ThemeMenuProps>(({ onOpenAdvancedSettings, externalOpen, onExternalOpenChange }) => {
  ...
  const accentTheme = useWorkspaceStore((state) => state.themeSettings.accentTheme || 'aurochs-gold')
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    height: 24,
                    background: color,
                    boxShadow: isActive ? `0 0 0 2px var(--surface-panel), 0 0 0 4px ${color}` : 'none'
                  }}
                  title={accent.label}
