...
export const WORKSPACE_TEMPLATES: WorkspaceTemplate[] = [
  ...
  // ============================================================================
  {
    ...
    description:
      'Learn Cognograph by exploring a pre-built workspace. No popups, no walkthroughs — the workspace is the tutorial.',
    icon: 'Compass',
    color: '#C8963E',
    category: 'tutorial',
    difficulty: 'beginner',
    ...
    nodes: [
      // N1: Start Here (text node — no title field on TextNodeData, title used for gallery only)
      {
        ...
        data: {
          ...
          title: 'Start Here',
          content:
            '<h2>This is your workspace.</h2><p>Everything you see here is a real node. You can move them, edit them, delete them, or keep them.</p><p>The conversation below is live. The notes above it are feeding context into it. That is how Cognograph works — <strong>arrange information spatially, and the AI sees it.</strong></p><p>Start by clicking the chat node below and saying something.</p>',
          contentFormat: 'html',
          color: '#C8963E',
          isLandmark: true,
          icon: 'compass',
      ...
      // N2: Project Brief (note node)
      {
        ...
        data: {
          ...
          title: 'Project Brief',
          content:
            'I am building a personal portfolio site. The audience is potential clients — small business owners and startup founders who need a designer who understands both code and strategy.\n\nKey constraints:\n- Must load in under 2 seconds\n- Mobile-first (70% of traffic is mobile)\n- No stock photography — real work samples only\n- Clear call-to-action on every page',
          ...
          messages: [
            {
              ...
              role: 'user',
              content:
                'Based on the project brief and design preferences, what would you recommend for the homepage hero section?',
      ...
      // N9: Project Node — Portfolio Site Build (collapsed by default)
      {
        ...
        data: {
          ...
          description:
            'This is a project node. It organizes related work into a collapsible group.\n\nExpand me to see what is inside.',
          color: '#C8963E',
          collapsed: true,
  ...
  // ============================================================================
  {
    ...
    description:
      'Analyze competitors with AI assistance. Perfect first template—shows context injection in action.',
    icon: 'Search',
    color: '#C8963E',
    category: 'research',
    difficulty: 'beginner',
    ...
    nodes: [
      {
        ...
        data: {
          ...
          description:
            'Analyze 3 competitors to identify market gaps and positioning opportunities',
          collapsed: false,
          childNodeIds: [],
        } as Partial<NodeData> & { title: string },
  ...
  // ============================================================================
  {
    ...
    description:
      'Blog post workflow with AI feedback loops. Draft, edit, and refine content with AI assistance.',
    icon: 'PenTool',
    color: '#F0EDE8',
    category: 'writing',
    difficulty: 'beginner',
  ...
  // ============================================================================
  {
    ...
    description:
      'Task management with AI assistance. Plan features, track progress, get implementation guidance.',
    icon: 'Code',
    color: '#10b981',
  ...
  // ============================================================================
  {
    ...
    name: 'Knowledge Base',
    description:
      'Organized notes with Q&A assistant. Build your personal knowledge graph with AI-powered search.',
    icon: 'Library',
    color: '#f59e0b',
    category: 'research',
    difficulty: 'beginner',
  ...
  // ============================================================================
  {
    ...
    description:
      'Orchestrator coordinates 3 AI agents in sequence. Demonstrates agentic workflow automation.',
    icon: 'Network',
    color: '#6366f1',
  ...
  // ============================================================================
  {
    ...
    description:
      'Extract action items from meeting transcripts. Auto-creates task nodes from conversations.',
    icon: 'ListChecks',
    color: '#ec4899',
    category: 'planning',
    difficulty: 'beginner',
  ...
  // ============================================================================
  {
    ...
    description:
      'Research paper workflow. Literature review → methodology → writing with AI guidance.',
    icon: 'GraduationCap',
    color: '#8b5cf6',
    category: 'writing',
    difficulty: 'intermediate',
  ...
  // ============================================================================
  {
    ...
    description:
      'Explore multiple creative directions. Fork conversations to try different story ideas.',
    icon: 'Lightbulb',
    color: '#f59e0b',
    category: 'writing',
    difficulty: 'beginner',
          ...
          messages: [
            {
              role: 'user',
              content:
                'Develop a plot where Sarah discovers an ancient alien structure beneath the ice',
              timestamp: Date.now() - 180000,
            },
            {
              role: 'assistant',
          ...
          messages: [
            {
              role: 'user',
              content:
                'Develop a plot where the anomaly is actually a corporate black site experiment gone wrong',
              timestamp: Date.now() - 180000,
            },
            {
              role: 'assistant',
  ...
  // ============================================================================
  {
    ...
    description:
      'AI-assisted code review. Get feedback on pull requests and create follow-up tasks.',
    icon: 'GitPullRequest',
    color: '#C8963E',
    category: 'development',
    difficulty: 'intermediate',
  ...
  // ============================================================================
  {
    ...
    edges: [
      { sourceTempId: 'note-example', targetTempId: 'conversation-tutorial', label: 'context' },
    ],
  },
]
